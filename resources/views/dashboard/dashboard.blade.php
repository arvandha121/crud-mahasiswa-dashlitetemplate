        ...
        <div class="nk-header nk-header-fixed is-light">
            <div class="container-xl wide-xl">
                <div class="nk-header-wrap">
                    <div class="nk-menu-trigger d-xl-none ms-n1 me-3"><a href="#"
                            class="nk-nav-toggle nk-quick-nav-icon" data-target="sidebarMenu"><em
                                class="icon ni ni-menu"></em></a></div>
                    <div class="nk-header-brand d-xl-none"><a href="/demo9/copywriter/index.html" class="logo-link"><img
                                class="logo-light logo-img" src="/demo9/images/logo.png"
                                srcset="/demo9/images/logo2x.png 2x" alt="logo"><img class="logo-dark logo-img"
                                src="/demo9/images/logo-dark.png" srcset="/demo9/images/logo-dark2x.png 2x"
                                alt="logo-dark"></a></div>
                    <div class="nk-header-menu is-light mobile-menu">
                        <div class="nk-header-menu-inner">
                            <ul class="nk-menu nk-menu-main">
                                <li class="nk-menu-item has-sub"><a href="#"
                                        class="nk-menu-link nk-menu-toggle"><span class="nk-menu-text">Editor</span></a>
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item"><a href="/demo9/copywriter/document-editor.html"
                                                class="nk-menu-link"><span class="nk-menu-text">New</span></a></li>
                                        <li class="nk-menu-item"><a
                                                href="/demo9/copywriter/document-editor-generate.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Generate</span></a></li>
                                        <li class="nk-menu-item"><a href="/demo9/copywriter/document-editor-edit.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Edit</span></a></li>
                                    </ul>
                                </li>
                                <li class="nk-menu-item has-sub"><a href="#"
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item"><a href="/demo9/copywriter/document-saved.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Saved</span></a></li>
                                        <li class="nk-menu-item"><a href="/demo9/copywriter/document-drafts.html"
                                                class="nk-menu-link"><span class="nk-menu-text">Drafts</span></a></li>
                                    </ul>
                                </li>
                                <li class="nk-menu-item"><a href="/demo9/copywriter/templates.html"
                                        class="nk-menu-link"><span class="nk-menu-text">Templates</span></a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <ul class="nk-quick-nav">
                                        ...
                                        <div class="nk-notification">
                                            <div class="nk-notification-item dropdown-inner">
                                                <div class="nk-notification-icon"><em
                                                        class="icon icon-circle bg-primary-dim ni ni-share"></em></div>
                                            ...
                                            <div class="nk-notification-item dropdown-inner">
                                                ...
                                                <div class="nk-notification-content">
                                                    <div class="nk-notification-text">Iliash <span>invited</span> you to
                                                        edit <span>DashLite</span> folder</div>
                                            ...
                                            <div class="nk-notification-item dropdown-inner">
                                                <div class="nk-notification-icon"><em
                                                        class="icon icon-circle bg-primary-dim ni ni-share"></em></div>
                                                <div class="nk-notification-content">
                                                    <div class="nk-notification-text">You have shared <span>project
                                                            v2</span> with Parvez.</div>
                                                    <div class="nk-notification-time">7 days ago</div>
                                                </div>
                                            </div>
                                            <div class="nk-notification-item dropdown-inner">
                                                <div class="nk-notification-icon"><em
                                                        class="icon icon-circle bg-success-dim ni ni-spark"></em></div>
                                                <div class="nk-notification-content">
                            ...
                            <li class="dropdown language-dropdown d-none d-sm-block me-n1"><a href="#"
                                    ...
                                    <div class="quick-icon border border-light"><img class="icon"
                                            src="/demo9/images/flags/english-sq.png" alt=""></div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <ul class="language-list">
                                        <li><a href="#" class="language-item"><img
                                                    src="/demo9/images/flags/english.png" alt=""
                                                    class="language-flag"><span
                                                    class="language-name">English</span></a>
                                        </li>
                                        <li><a href="#" class="language-item"><img
                                                    src="/demo9/images/flags/spanish.png" alt=""
                                                    class="language-flag"><span
                                                    class="language-name">Español</span></a>
                                        </li>
                                        <li><a href="#" class="language-item"><img
                                                    src="/demo9/images/flags/french.png" alt=""
                                                    class="language-flag"><span
                                                    class="language-name">Français</span></a>
                                        </li>
                                        <li><a href="#" class="language-item"><img
                                                    src="/demo9/images/flags/turkey.png" alt=""
                                                    class="language-flag"><span
                            ...
                            <li class="dropdown user-dropdown"><a href="#" class="dropdown-toggle"
                                ...
                                <div class="dropdown-menu dropdown-menu-md dropdown-menu-end">
                                    ...
                                    <div class="dropdown-inner">
                                        <ul class="link-list">
                                            <li><a href="/demo9/copywriter/profile.html"><em
                                                        class="icon ni ni-user-alt"></em><span>View Profile</span></a>
                                            </li>
                                            <li><a href="/demo9/copywriter/history.html"><em
                                                        class="icon ni ni-clock"></em><span>View History</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="dropdown-inner">
                ...
                <div class="nk-content-body">
                                    ...
                                    <div class="card-inner">
                                        <div class="d-flex align-items-center justify-content-between mb-1">
                                            <div class="fs-6 text-white text-opacity-75 mb-0">Words Available</div><a
                                                href="/demo9/copywriter/history.html" class="link link-white">See
                                                History</a>
                                        </div>
                                    ...
                                    <div class="card-inner">
                                        <div class="d-flex align-items-center justify-content-between mb-1">
                                            <div class="fs-6 text-white text-opacity-75 mb-0">Drafts Available</div><a
                                                href="/demo9/copywriter/document-drafts.html"
                                                class="link link-white">See
                                                All</a>
                                        </div>
                                ...
                                <div class="card card-full bg-info is-dark">
                                    <div class="card-inner">
                                        <div class="d-flex align-items-center justify-content-between mb-1">
                                            ...
                                            <a href="/demo9/copywriter/document-saved.html"
                                                class="link link-white">See
                                                All</a>
                                        </div>
                                    ...
                                    <div class="card-inner">
                                        <div class="d-flex align-items-center justify-content-between mb-1">
                                            <div class="fs-6 text-white text-opacity-75 mb-0">Tools Available</div><a
                                                href="/demo9/copywriter/templates.html" class="link link-white">All
                                                Tools</a>
                                        </div>
                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-between">
                            ...
                            <div class="nk-block-head-content"><a href="/demo9/copywriter/templates.html"
                        ...
                        <div class="row g-gs">
                            <div class="col-sm-6 col-xxl-3">
                                <div class="card card-full">
                                    <div class="card-inner">
                                        <div class="user-avatar text-primary bg-primary-dim mb-3"><em
                                                class="icon ni ni-bulb-fill"></em></div>
                            ...
                            <div class="col-sm-6 col-xxl-3">
                                <div class="card card-full">
                                    <div class="card-inner">
                                        ...
                                        <div class="user-avatar text-blue bg-blue-dim mb-3"><em
                                                class="icon ni ni-spark-fill"></em></div>
                            ...
                            <div class="col-sm-6 col-xxl-3">
                                <div class="card card-full">
                                    <div class="card-inner">
                                        <div class="user-avatar text-danger bg-danger-dim mb-3"><em
                                                class="icon ni ni-youtube-fill"></em></div>
                            ...
                            <div class="col-sm-6 col-xxl-3">
                                <div class="card card-full">
                                    <div class="card-inner">
                                        <div class="user-avatar text-purple bg-purple-dim  mb-3"><em
                                                class="icon ni ni-laptop"></em></div>
                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-between">
                            ...
                            <div class="nk-block-head-content"><a href="/demo9/copywriter/document-saved.html"
                                    class="link"><span>See All</span> <em class="icon ni ni-chevron-right"></em></a>
                            </div>
                        </div>
                    </div>
                    <div class="nk-block">
                                    ...
                                    <tr class="nk-tb-item nk-tb-head">
                                        <th class="nk-tb-col nk-tb-col-check">
                                            <div class="custom-control custom-control-sm custom-checkbox notext"><input
                                                    ...
                                                    id="did-all"><label class="custom-control-label"
                                                    for="did-all"></label></div>
                                        </th>
                                        <th class="nk-tb-col">
                                ...
                                <tbody>
                                    <tr class="nk-tb-item">
                                        <td class="nk-tb-col nk-tb-col-check">
                                            <div class="custom-control custom-control-sm custom-checkbox notext"><input
                                                    type="checkbox" class="custom-control-input"
                                                    id="did-01"><label class="custom-control-label"
                                                    for="did-01"></label></div>
                                        </td>
                                        <td class="nk-tb-col">
                                            <div class="caption-text">The Impact of Artificial Intelligence on the
                                                Future
                                                of Work</div>
                                        </td>
                                        ...
                                        <td class="nk-tb-col tb-col-end">
                                            <div class="dropdown"><button
                                                    class="btn btn-sm btn-icon btn-trigger me-n1" type="button"
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <div class="dropdown-content">
                                                        <ul class="link-list-opt no-bdr">
                                                            ...
                                                            <li><a href="#"><em
                                                                        class="icon ni ni-trash"></em><span>Move to
                                                                        Trash</span></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                    ...
                                    <tr class="nk-tb-item">
                                        <td class="nk-tb-col nk-tb-col-check">
                                            <div class="custom-control custom-control-sm custom-checkbox notext"><input
                                                    type="checkbox" class="custom-control-input"
                                                    id="did-02"><label class="custom-control-label"
                                                    for="did-02"></label></div>
                                        </td>
                                        <td class="nk-tb-col">
                                            <div class="caption-text">How to Boost Your Online Presence with Social
                                                Media
                                                Marketing</div>
                                        </td>
                                        <td class="nk-tb-col tb-col-sm">
                                    ...
                                    <tr class="nk-tb-item">
                                        <td class="nk-tb-col nk-tb-col-check">
                                            <div class="custom-control custom-control-sm custom-checkbox notext"><input
                                                    type="checkbox" class="custom-control-input"
                                                    id="did-03"><label class="custom-control-label"
                                                    for="did-03"></label></div>
                                        </td>
                                        <td class="nk-tb-col">
                                    ...
                                    <tr class="nk-tb-item">
                                        <td class="nk-tb-col nk-tb-col-check">
                                            <div class="custom-control custom-control-sm custom-checkbox notext"><input
                                                    type="checkbox" class="custom-control-input"
                                                    id="did-04"><label class="custom-control-label"
                                                    for="did-04"></label></div>
                                        </td>
                                        <td class="nk-tb-col">
                                            <div class="caption-text">Transforming Healthcare with Big Data: Exploring
                                                the
                                                Opportunities</div>
                                        </td>
                                        <td class="nk-tb-col tb-col-sm">
                                            <div class="badge badge-dim bg-warning rounded-pill">Website Copy &amp; SEO
                                            </div>
                                        </td>
                                        <td class="nk-tb-col tb-col-md">
                                            <div class="sub-text d-inline-flex flex-wrap gx-2">
        ...
        <div class="nk-footer">
            <div class="container-xl wide-xl">
                <div class="nk-footer-wrap">
                    <div class="nk-footer-copyright"> © 2023 DashLite. Template by <a href="https://softnio.com"
                            target="_blank">Softnio</a></div>
                    <div class="nk-footer-links">
                        <ul class="nav nav-sm">
                            <li class="nav-item dropup active current-page"><a herf=""
