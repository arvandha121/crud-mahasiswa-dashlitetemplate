                            ...
                            <form method="POST" action="{{ route('mahasiswa.store') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nim" name="nim"
                                        value="{{ $data->nim }}" @if ($data->nim) disabled @endif>
                                </div>
                                <div class="mb-3">
                                    <label for="nama" class="form-label">Nama</label>
                                    <input type="text" class="form-control" id="nama" name="nama"
                                        value="{{ $data->nama }}" @if ($data->nama) disabled @endif>
                                </div>
                                <div class="mb-3">
                                    <label for="tanggal_lahir" class="form-label">Tanggal Lahir</label>
                                    <input type="text" class="form-control" id="tanggal_lahir"
                                        name="tanggal_lahir" value="{{ $data->tanggal_lahir }}"
                                        @if ($data->tanggal_lahir) disabled @endif>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="kota" name="kota"
                                        value="{{ $data->kota }}" @if ($data->kota) disabled @endif>
                                </div>
                                <div class="mt-4 mb-4">
